...
## Manage Collections
Form your Shopper admin on the sidebar go to **Collections**. The display page is rendered by the Livewire component `Shopper\Http\Livewire\Collections\Browse` and for the display of the collections table is the component `Shopper\Http\Livewire\Tables\CollectionsTable`.
...
use Shopper\Repositories\Ecommerce\CollectionRepository;
