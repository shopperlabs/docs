---
title: "Legal"
description: "As with any e-commerce site, it is important for users to know the terms and conditions and privacy policy that your site offers. This is for their own safety and yours as well."
---
...
<Frame caption="Settings > Legal">
  <img src="/images/v1/settings-legal.png" alt="legal setting" />
</Frame>
...
<Frame caption="Legal pages">
  <img src="/images/v1/legal-screenshot.png" alt="legal pages" />
</Frame>
...
@section('body')
    ...
    <x-legal-layout>
        <x-slot name="title">
            <h2 className="text-2xl font-bold uppercase text-dark tracking-wider font-heading sm:text-3xl">
                {{ __('Privacy Policy') }}
            </h2>
            <span className="text-sm leading-5 text-gray-500">{{ __('Last update: :date', ['date' => $legal->created_at->format('d, F Y')]) }}</span>
        </x-slot>
