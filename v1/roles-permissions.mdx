...
description: "Manage access and permissions of your users and members in your store."
---
...
<Frame caption="Settings > Staff & permissions">
  <img src="/images/v1/settings-staff.png" alt="Setting Staff & permissions" />
</Frame>
...
<Frame caption="Roles & Admins">
  <img src="/images/v1/roles-admins.png" alt="roles and admins users" />
</Frame>
...
<Frame caption="Add new role">
  <img src="/images/v1/add-role.png" alt="addd new role" />
</Frame>
...
<Frame caption="Update role">
  <img src="/images/v1/update-role.png" alt="update role" />
</Frame>
...
<Frame caption="Role's permissions example">
  <img src="/images/v1/permissions-browse.png" alt="Role's permissions example" />
</Frame>
...
<Frame caption="Add permission">
  <img src="/images/v1/add-permission.png" alt="Add permission" />
</Frame>
...
<Frame caption="New permission">
  <img src="/images/v1/custom-permissions.png" alt="new permission" />
</Frame>
