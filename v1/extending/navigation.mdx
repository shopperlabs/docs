---
title: Navigation
description: Learn how to customize and extend the Shopper control panel navigation by adding your own sections, pages, and menu items.
---
...
<Info>
We assume here that you have already seen how to add routes for our administration explained in this [section](/v1/extending/control-panel#adding-control-panel-routes).
</Info>
    ...
    public function extendWith(Menu $menu): Menu
    {
        $menu->group(__('Blog'), function (Group $group) {
            ...
            $group->item(__('Posts'), function (Item $item) {
                ...
                $item->icon('
                    <svg className="flex-shrink-0 -ml-1 mr-3 h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
...
<Frame>
    <img src="/images/v1/sidebar-screen.png" alt="Blog sidebar" />
</Frame>
