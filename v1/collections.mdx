---
title: "Collections"
description: "Collections, although not strictly the same, are akin to Categories. They serve to allow you to add products ,either explicitly or via certain criteria, for use on your store."
---
...
<Frame caption="Collections">
  <img src="/images/v1/collections.png" alt="Collections" />
</Frame>
...
<Frame caption="Collections empty data">
  <img src="/images/v1/collection-empty-state.png" alt="Collections empty data" />
</Frame>

### Create collection
Click on the "Create" button on the collections page, and a creation form appears.

<Frame caption="Create collection">
  <img src="/images/v1/create-collection.png" alt="Create collection form" />
</Frame>
...
<Frame caption="Automatic collection rules">
  <img src="/images/v1/collection-rules.png" alt="automatic collection rules" />
</Frame>
...
<Frame caption="Example display for collections">
  <img src="/images/v1/collections-preview.png" alt="example collection rules" />
</Frame>
