---
title: "Dashboard"
description: "The dashboard is a user-customizable screen. One of Shopper's main goals is to enable stores to easily customize the modules."
---
...
<Frame caption="The dashboard and the Getting Started panel">
  <img src="/images/v1/dashboard.png" alt="Shopper Global Set Example" />
</Frame>
