...
<Frame caption="Two factor section">
...
<Frame caption="Two factor QRcode & Recovery Code">
  <img src="/images/v2/two-factor-code.png" alt="Two factor code Screenshot" />
</Frame>

This feature is inspired by [Laravel Fortify](https://laravel.com/v2/9.x/fortify) which is implemented in [Laravel Jetstream](https://jetstream.laravel.com/2.x/introduction.html)
...
<Frame caption="Two factor Login">
  <img src="/images/v2/two-factor-authentication.png" alt="Two factor login Screenshot" />
</Frame>
...
<Frame caption="Two factor disable">
