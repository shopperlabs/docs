---
title: Legal
description: Manage legal pages like privacy policy, terms of service, and shipping policies
---
...
`Legal::enabled()` is a scope to retrieve the page only when it is available. This is a simple way to retrieve the pages but you can do it otherwise all the front-end code depends on you. To learn more about the scopes you can consult the [documentation](https://laravel.com/v2/10.x/eloquent#local-scopes).
