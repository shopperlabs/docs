...
Database columns remain unchanged — no migration needed.
...
<Steps>
  ...
  <Step title="Update 2FA traits">
    Replace `TwoFactorAuthenticatable` with the new interfaces and traits if you override the User model.
  </Step>
