...
<Frame>
  <img src="/images/v2/ug-tags-list.png" alt="Tags list page" />
</Frame>

{/* SCREENSHOT NEEDED: The Products > Tags page showing a table of tags.
    Show 4-5 tags: "Summer 2026", "New Arrival", "Best Seller", "Eco-Friendly", "Flash Sale".
    Include columns: Name, Slug, Created date. Show edit and delete action icons per row. */}
...
<Frame>
  <img src="/images/v2/ug-tags-create.png" alt="Create tag form" />
</Frame>
...
<Frame>
  <img src="/images/v2/ug-tags-edit.png" alt="Edit tag form" />
</Frame>
...
<Frame>
  <img src="/images/v2/ug-tags-product.png" alt="Tags field on product edit form" />
</Frame>
