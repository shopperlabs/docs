...
<Frame>
  <img src="/images/v2/ug-suppliers-list.png" alt="Suppliers list page" />
</Frame>

{/* SCREENSHOT NEEDED: The Products > Suppliers page showing a table of suppliers.
    Show 2-3 suppliers: "TechParts Co." with email and phone, "Fashion Direct" with
    website URL. Include columns: Name, Email, Status toggle, Updated date.
    Show edit and delete action icons. */}
...
<Frame>
  <img src="/images/v2/ug-suppliers-create.png" alt="Add supplier form" />
</Frame>

{/* SCREENSHOT NEEDED: The "Add supplier" slide-over form with fields filled in:
    Name: "TechParts Co., Ltd", Email: "orders@techparts.com",
    Phone: "+86 755 1234 5678", Contact Name: "Zhang Wei",
    Website: "https://techparts.com", Description filled in,
...
<Frame>
  <img src="/images/v2/ug-suppliers-product.png" alt="Supplier field on product form" />
</Frame>
