...
<Frame>
  <img src="/images/v2/ug-taxes-list.png" alt="Tax settings page" />
</Frame>

{/* SCREENSHOT NEEDED: The Settings > Taxes page showing a list of tax zones on the left
    (e.g., "France - Standard VAT", "California Sales Tax") and the selected zone's
    tax rates on the right. */}
...
<Frame>
  <img src="/images/v2/ug-tax-zone-form.png" alt="Create tax zone form" />
</Frame>

{/* SCREENSHOT NEEDED: The tax zone creation form with fields:
    Country: "France" selected, Province Code: empty,
    Name: "Standard VAT", Tax Inclusive toggle: ON. */}
...
<Frame>
  <img src="/images/v2/ug-tax-rate-form.png" alt="Add tax rate form" />
</Frame>

{/* SCREENSHOT NEEDED: The tax rate creation form with fields:
    Name: "TVA 20%", Code: "FR_VAT_STANDARD", Rate: "20",
    Default toggle: ON, Combinable toggle: OFF. */}
...
<Frame>
  <img src="/images/v2/ug-tax-rate-override.png" alt="Tax rate override form" />
</Frame>
