...
<Frame>
  <img src="/images/v2/ug-shipping-option-form.png" alt="Add shipping option form" />
</Frame>

{/* SCREENSHOT NEEDED: The "Add shipping option" slide-over form with fields:
    Carrier dropdown: "Colissimo" selected, Name: "Standard Delivery",
    Description: "Delivered in 3-5 business days", Price: "5.99",
...
<Frame>
  <img src="/images/v2/ug-zone-shipping-options.png" alt="Zone shipping options list" />
</Frame>

{/* SCREENSHOT NEEDED: The Shipping Options section within a zone detail page.
    Show a list of 2-3 options: "Colissimo - Standard Delivery" at €5.99 (enabled),
    "Colissimo - Express 24h" at €14.99 (enabled), "Free Shipping" at €0.00 (enabled).
    Each with edit and delete action icons. */}
