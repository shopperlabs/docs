---
title: Attributes
description: Learn how to manage Attributes in your Shopper administration.
---
...
<Frame caption="Attributes">
  <img src="/images/v2/attributes.png" alt="Attributes" />
</Frame>
...
The types are available via the `Shopper\Core\Enum\FieldType` Enum className and the available values are:
...
<Frame caption="Create Attribute">
