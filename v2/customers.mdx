---
title: Customers
description: Learn how to manage Customers in your Shopper administration.
---
...
<Frame caption="Customers">
  <img src="/images/v2/customers.png" alt="Customers" />
</Frame>

During the [installation](/v2/installing#update-existing-files) of Shopper, one of the first things required is to inherit to our model User the features of the model User that is in Shopper.
...
<Frame caption="Customer address form">
  <img src="/images/v2/customer-address.png" alt="customer address form" />
</Frame>
...
<Frame caption="Customer informations">
  <img src="/images/v2/customer-informations.png" alt="customer informations" />
</Frame>
