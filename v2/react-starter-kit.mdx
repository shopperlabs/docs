...
sidebarTitle: React
description: A production-ready storefront built with Inertia, React 19, shadcn/ui and Tailwind CSS v4.
---
...
<Frame>
  <img src="/images/v2/inertia-starterkit.png" alt="React Starter Kit storefront" />
</Frame>
...
The starter kit publishes files into standard Laravel directories. The backend is shared with the [Vue Starter Kit](/v2/vue-starter-kit); only the `resources/js` frontend differs. Here is the full structure.
