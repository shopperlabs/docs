...
| `OrderStatus` | `ARCHIVED`, `NEW`, `SHIPPED`, `DELIVERED`, `PENDING`, `PAID`, `REGISTER`, `COMPLETED`, `CANCELLED` |
| `FulfillmentStatus` | `UNFULFILLED`, `PARTIALLY_FULFILLED`, `FULFILLED`, `CANCELLED` |
| `OrderRefundStatus` | `PENDING`, `TREATMENT`, `PARTIAL_REFUND`, `REFUNDED`, `CANCELLED`, `REJECTED` |
