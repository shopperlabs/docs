...
But if you want to customize your dashboard using Tailwind css you must first install Tailwind in your project. You can read the [documentation](https://tailwindcss.com/v2/guides/laravel)
...
Just load the default shopper CSS inside your `./resources/css/shopper.css`
...
@source '../../../../vendor/shopper/**/*.blade.php';
```
